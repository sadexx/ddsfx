...
@Injectable()
export class ExternalSyncQueryOptionsService {
  constructor() {}
  ...
  public loadDeceasedWithRelationsOptions(queryBuilder: SelectQueryBuilder<Deceased>, deceasedId?: string): void {
    ...
    if (deceasedId) {
      queryBuilder.where('deceased.id = :deceasedId', { deceasedId });
    }
