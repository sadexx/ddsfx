...
export const loadEnv = registerAs(ENV_CONFIG_TOKEN, (): EnvConfig => {
  const rawEnv: RawEnvConfig = {
    ...
    POSTGRES_EXTERNAL_USER: process.env['POSTGRES_EXTERNAL_USER'],
    POSTGRES_EXTERNAL_DB: process.env['POSTGRES_EXTERNAL_DB'],
    POSTGRES_EXTERNAL_PASSWORD: process.env['POSTGRES_EXTERNAL_PASSWORD'],
